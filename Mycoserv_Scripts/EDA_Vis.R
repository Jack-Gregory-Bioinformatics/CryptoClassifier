...
# Read the combined_data.csv file from the global variable
combined_data <- read.csv(paste0(Sys.getenv("CSV_DIRECTORY"), "/combined_data.csv")) # nolint: line_length_linter.
...
ggsave("scatterplot_diameter_vs_mean_fluorescence.png", device = "png", width = 8, height = 6) # nolint
